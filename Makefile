#############################################################################
# Makefile for building: cucoview
# Generated by qmake (2.01a) (Qt 4.4.3) on: Sat Jun 20 14:36:18 2009
# Project:  cucoview.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.4.3/bin/qmake -unix -o Makefile cucoview.pro
#############################################################################
...
Makefile: cucoview.pro  /usr/local/Trolltech/Qt-4.4.3/mkspecs/linux-g++/qmake.conf /usr/local/Trolltech/Qt-4.4.3/mkspecs/common/g++.conf \
		/usr/local/Trolltech/Qt-4.4.3/mkspecs/common/unix.conf \
		/usr/local/Trolltech/Qt-4.4.3/mkspecs/common/linux.conf \
		/usr/local/Trolltech/Qt-4.4.3/mkspecs/qconfig.pri \
		/usr/local/Trolltech/Qt-4.4.3/mkspecs/features/qt_functions.prf \
	...
	$(QMAKE) -unix -o Makefile cucoview.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/cucoview1.0.0 || $(MKDIR) .tmp/cucoview1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/cucoview1.0.0/ && $(COPY_FILE) --parents glwidget.h snap.h window.h .tmp/cucoview1.0.0/ && $(COPY_FILE) --parents glwidget.cpp main.cpp snap.cpp window.cpp .tmp/cucoview1.0.0/ && (cd `dirname .tmp/cucoview1.0.0` && $(TAR) cucoview1.0.0.tar cucoview1.0.0 && $(COMPRESS) cucoview1.0.0.tar) && $(MOVE) `dirname .tmp/cucoview1.0.0`/cucoview1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/cucoview1.0.0
